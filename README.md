...
Web-based remote photo frame slideshow and gallery manager for use with simple smart photo frames or e-ink displays such as the [Inky Frame](https://learn.pimoroni.com/article/getting-started-with-inky-frame) and [Impression](https://shop.pimoroni.com/products/inky-impression-5-7?variant=32298701324371).
